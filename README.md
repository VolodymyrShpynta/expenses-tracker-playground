...
| `expenses-tracker-mobile/` (Expo / RN)    | [`expenses-tracker-mobile/README.md`](./expenses-tracker-mobile/README.md)     | Running the mobile app, simulator / emulator setup, dev client with `npm run android`, building & sideloading a production APK, Cloud-Drive OAuth client IDs (Google Drive / OneDrive).                                                                           |
